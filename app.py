...
model = pickle.load(open(r"C:\Users\Aun Electronic\Desktop\sentiment analysis\model (1).pkl", "rb"))
vectorizer = pickle.load(open(r"C:\Users\Aun Electronic\Desktop\sentiment analysis\vectorizer (1).pkl", "rb"))
